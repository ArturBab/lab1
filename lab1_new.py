...
# проверка ввода корректности
        while (tester != True):
            ...
            try:
                ...
                tester = False
                print("Вы неправильно ввели значение!! Пожалуйста, введите значение еще раз!\n")        
    return coef
...
def get_roots(a, b, c):
    ...
    if D == 0.0:
        ...
        if root >= 0.0:
            ...
            result.append('Данного корня нет!')
            result.append('Данного корня нет!')
...
def main():
    ...
    if len_roots == 0:
        ...
        print('Два корня : x1 = {}; x2 = {}; x3 = {}; x4 = {}'.format(roots[0], roots[1], roots[2],
                                                                     roots[3]))
    elif len_roots == 5:

        print('Может быть любое число по x')
